...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 w-full max-w-full z-40 bg-white/95 backdrop-blur-lg border-t border-slate-200 shadow-xl md:hidden overflow-hidden box-border">
      <div className="flex items-center justify-between h-16 w-full max-w-full px-2 box-border">
        ...
        >
          <div className={`p-1.5 rounded-xl transition-all flex flex-col items-center justify-center ${activeTab === 'catalog' ? 'bg-emerald-100/70 text-[#053D27]' : ''}`}>
        ...
        >
          <div className={`p-1.5 rounded-xl transition-all flex flex-col items-center justify-center ${activeTab === 'events' ? 'bg-emerald-100/70 text-[#053D27]' : ''}`}>
        ...
        <button
          ...
          className="flex flex-col items-center justify-center -mt-4 mx-1 flex-shrink-0 outline-none focus:outline-none focus:ring-0 select-none"
        ...
        >
          <div className={`p-1.5 rounded-xl transition-all flex flex-col items-center justify-center relative ${activeTab === 'profile' ? 'bg-emerald-100/70 text-[#053D27]' : ''}`}>
        ...
        {member.role === 'admin' && (
          ...
          >
            <div className={`p-1.5 rounded-xl transition-all flex flex-col items-center justify-center ${activeTab === 'admin' ? 'bg-emerald-100/70 text-[#053D27]' : ''}`}>
              <Shield className="w-5 h-5" />
            </div>
            <span className="text-[10px] mt-0.5 font-extrabold tracking-tight truncate max-w-full">Admin</span>
          </button>
        )}
