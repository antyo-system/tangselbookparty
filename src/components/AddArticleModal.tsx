...
import { X, BookMarked, Sparkles, Search, CheckCircle2, AlertCircle, Info } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-anton text-lg sm:text-xl tracking-wide text-white">
                {articleToEdit ? 'EDIT ARTIKEL CMS' : 'TAMBAH ARTIKEL CMS BARU'}
              </h3>
              <p className="text-[11px] text-emerald-200 font-medium">Content Engine & Live SEO Optimization Audit</p>
            </div>
          </div>
