...
export const CatalogPage: React.FC<CatalogPageProps> = ({
  ...
  return (
    <div className="space-y-5 pb-16">
      ...
      {/* Essential Crisp Hero Banner */}
      <section className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#053D27] to-[#03321F] text-white p-5 sm:p-7 border border-[#FFBF00]/30 shadow-sm">
        <div className="relative z-10 max-w-2xl space-y-2">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-0.5 rounded-full bg-[#03321F] text-[#D0DF00] text-xs font-extrabold border border-[#D0DF00]/30">
            ...
            <span>PERPUSTAKAAN BUKU FISIK KOMUNITAS TANGSEL</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-emerald-100/90 leading-relaxed font-medium">
            Jelajahi koleksi buku fisik milik sesama pembaca di Bintaro, BSD, Pamulang, & Ciputat. Peminjaman gratis antar anggota komunitas dengan opsi durasi 7 hingga 21 hari.
          </p>
      ...
      <section className="space-y-2.5">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 bg-white p-3 rounded-xl border border-slate-200 shadow-sm text-slate-800">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="px-2.5 py-1 text-xs font-bold bg-slate-50 text-slate-800 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#053D27]"
            >
      ...
      {/* High-Density Book Grid (5 to 6 columns on larger screens) */}
      <section>
